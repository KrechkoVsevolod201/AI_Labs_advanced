...
Результаты показали, что BERT (accuracy 0.873) незначительно уступает baseline-модели (0.876) на небольшой подвыборке данных,
но демонстрирует лучшие показатели F1-меры и более устойчиво работает с несбалансированными данными. Это подтверждает преимущество трансформеров для сложных NLP-задач при достаточном объеме данных и вычислительных ресурсах.
